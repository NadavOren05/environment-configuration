...
/home/linuxbrew/.linuxbrew/bin/figlet -w 120 "$greeting" | /home/linuxbrew/.linuxbrew/bin/lolcat
...
# Uncomment the follo0wing line to use case-sensitive completion.
# CASE_SENSITIVE="true"
...
# Enable automatic updates for oh-my-zsh without user prompts.
...
# Customization for the AWS theme in oh-my-zsh.
...
# Include Terraform workspace in the shell prompt.
RPROMPT='$(tf_prompt_info)'$RPROMPT
ZSH_THEME_TF_PROMPT_PREFIX=""
ZSH_THEME_TF_PROMPT_SUFFIX="🎢"

# Include Kubernetes information in the shell prompt.
# Hide it on shell startup using kubeoff.
...
# Created by `pipx` on 2024-03-18 09:32:55
export PATH="$PATH:$HOME/.local/bin"
export BROWSER="/usr/bin/google"
export GPG_TTY=$TTY
